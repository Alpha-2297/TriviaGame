...
print("\nHi, I'm Alpha 🐺 ")
time.sleep(1)
print("Am your assistant and I'm gonna guide you all through the game.")
...
if wtp in positive:
...
elif wtp in negative:
    print(f"Okay {name} \n Can you please GTF outta my game now?")
    time.sleep(1)
    ...
    while wtp not in ans:
        print("Please type in a proper answer")
        wtp = input("I said... Will you like to play? >>> ").lower()
    ...
    if age < 18:
        while age < 18:
            ...
            if age >= 18:
                ...
                time.sleep(1)
                print("💡   This is a Trivia game with 30 interesting questions for you.\n     At the end of this excercise, your score will be calculated \n     automatically for you to view your results.\n")
                time.sleep(5)
                print(f"     {name} do you think you can get all 30 answers correctly? \n")
                time.sleep(1)
                input("     Strike the 'ENTER' button let's begin! \n")
                time.sleep(2)
                print("\n     !!!!!Game On!!!!!")
